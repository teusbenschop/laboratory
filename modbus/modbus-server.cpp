...
int main ()
{
    ...
    mapping->tab_registers[10] = 100;
    mapping->tab_registers[11] = 110;
    mapping->tab_registers[12] = 120;
    ...
    while (keep_going) {
        ...
        while (keep_going) {
            ...
            counter++;
            cout << counter << " responding" << endl;

            mapping->tab_registers[10] += 1;
            mapping->tab_registers[11] += 1;
            mapping->tab_registers[12] += 1;
            ...
            cout << "input register [1]: " << mapping->tab_registers[10] << endl;
