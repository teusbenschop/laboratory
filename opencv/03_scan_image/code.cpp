...
{
  cout << "This program shows how to scan image objects in OpenCV (cv::Mat)." << endl;
  cout << "As use case we take an input image and divide the native color palette (255) with the input." << endl;
  cout << "Shows C operator[] method, iterators and at function for on-the-fly item address calculation." << endl;
  cout << "Usage:" << endl;
  cout << "./example <imageNameToUse> <divideWith> [G]" << endl;
  cout << "If you add a G parameter the image is processed in gray scale" << endl;
